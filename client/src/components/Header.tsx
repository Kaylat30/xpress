...
const {activeLink} = useSelector((state:RootState) => state.activelink);
  return (<> 
    ...
    <div className={`fixed top-0 right-0 ${isActive?"main-active":"main"} transition-all duration-500 ease-in-out  bg-white flex justify-between items-center w-auto h-20 px-2 pl-5 sm:pl-5 border-b-2 border-blue-50`}>
